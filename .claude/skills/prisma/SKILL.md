...
npm run db:generate --workspace=apps/app
npm run db:generate --workspace=apps/api
npm run db:generate --workspace=apps/portal
...
# 2. Create migration
cd packages/db && npx prisma migrate dev --name add_user_role
...
npx prisma migrate dev  # ✅ Created migration
