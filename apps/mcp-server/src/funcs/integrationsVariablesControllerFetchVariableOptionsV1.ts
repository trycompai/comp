...
import {
  VariablesControllerFetchVariableOptionsV1Request,
  VariablesControllerFetchVariableOptionsV1Request$zodSchema,
  VariablesControllerFetchVariableOptionsV1Security,
} from "../models/variablescontrollerfetchvariableoptionsv1op.js";
 ...
 */
export function integrationsVariablesControllerFetchVariableOptionsV1(
  client$: CompAiCore,
  security: VariablesControllerFetchVariableOptionsV1Security,
  request: VariablesControllerFetchVariableOptionsV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      VariablesControllerFetchVariableOptionsV1Request$zodSchema.parse(value$),
