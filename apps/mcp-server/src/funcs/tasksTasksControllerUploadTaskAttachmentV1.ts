...
import {
  ...
  TasksControllerUploadTaskAttachmentV1Request$zodSchema,
  TasksControllerUploadTaskAttachmentV1Security,
} from "../models/taskscontrolleruploadtaskattachmentv1op.js";
...
export function tasksTasksControllerUploadTaskAttachmentV1(
  client$: CompAiCore,
  security: TasksControllerUploadTaskAttachmentV1Security,
  request: TasksControllerUploadTaskAttachmentV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      TasksControllerUploadTaskAttachmentV1Request$zodSchema.parse(value$),
