...
import { OffboardingChecklistControllerGetPendingOffboardingsV1Security } from "../models/offboardingchecklistcontrollergetpendingoffboardingsv1op.js";
...
export function offboardingChecklistOffboardingChecklistControllerGetPendingOffboardingsV1(
  client$: CompAiCore,
  security: OffboardingChecklistControllerGetPendingOffboardingsV1Security,
...
> {
  ...
  const context = {
    ...
    operationID: "OffboardingChecklistController_getPendingOffboardings_v1",
    oAuth2Scopes: null,
