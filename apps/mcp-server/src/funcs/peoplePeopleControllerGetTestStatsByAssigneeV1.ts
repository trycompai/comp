...
import { PeopleControllerGetTestStatsByAssigneeV1Security } from "../models/peoplecontrollergetteststatsbyassigneev1op.js";
 ...
 */
export function peoplePeopleControllerGetTestStatsByAssigneeV1(
  client$: CompAiCore,
  security: PeopleControllerGetTestStatsByAssigneeV1Security,
...
> {
  const path$ = pathToFunc("/v1/people/test-stats/by-assignee")();
