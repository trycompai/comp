...
import { OrganizationControllerRevokeApiKeyV1Security } from "../models/organizationcontrollerrevokeapikeyv1op.js";
...
export function organizationOrganizationControllerRevokeApiKeyV1(
  client$: CompAiCore,
  security: OrganizationControllerRevokeApiKeyV1Security,
