...
import {
  ...
  PoliciesControllerUploadPolicyPdfV1Request$zodSchema,
  PoliciesControllerUploadPolicyPdfV1Security,
} from "../models/policiescontrolleruploadpolicypdfv1op.js";
 ...
 */
export function policiesPoliciesControllerUploadPolicyPdfV1(
  client$: CompAiCore,
  security: PoliciesControllerUploadPolicyPdfV1Security,
  request: PoliciesControllerUploadPolicyPdfV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      PoliciesControllerUploadPolicyPdfV1Request$zodSchema.parse(value$),
