...
import {
  CloudSecurityControllerMarkFindingAsExceptionV1Request,
  CloudSecurityControllerMarkFindingAsExceptionV1Request$zodSchema,
} from "../models/cloudsecuritycontrollermarkfindingasexceptionv1op.js";
...
export function cloudSecurityCloudSecurityControllerMarkFindingAsExceptionV1(
  client$: CompAiCore,
  request: CloudSecurityControllerMarkFindingAsExceptionV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      CloudSecurityControllerMarkFindingAsExceptionV1Request$zodSchema.parse(
        value$,
      ),
  ...
  const pathParams$ = {
    findingId: encodeSimple("findingId", payload$.findingId, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path$ = pathToFunc("/v1/cloud-security/findings/{findingId}/exception")(
    pathParams$,
  );
