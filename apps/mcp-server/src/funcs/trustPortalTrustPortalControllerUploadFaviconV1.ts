...
import { TrustPortalControllerUploadFaviconV1Security } from "../models/trustportalcontrolleruploadfaviconv1op.js";
 ...
 */
export function trustPortalTrustPortalControllerUploadFaviconV1(
  client$: CompAiCore,
  security: TrustPortalControllerUploadFaviconV1Security,
...
> {
  const path$ = pathToFunc("/v1/trust-portal/favicon")();
