...
import { ExchangeCodeDto } from "../models/exchangecodedto.js";
...
> {
  const path$ = pathToFunc("/v1/device-agent/exchange-code")();
  ...
  const context = {
    ...
    operationID: "DeviceAgentController_exchangeCode_v1",
    oAuth2Scopes: null,
