...
import { TrustPortalControllerUpdateAllowedDomainsV1Security } from "../models/trustportalcontrollerupdatealloweddomainsv1op.js";
 ...
 */
export function trustPortalTrustPortalControllerUpdateAllowedDomainsV1(
  client$: CompAiCore,
  security: TrustPortalControllerUpdateAllowedDomainsV1Security,
...
> {
  const path$ = pathToFunc("/v1/trust-portal/settings/allowed-domains")();
