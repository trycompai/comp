...
import {
  CloudSecurityControllerGetCheckDefinitionV1Request,
  CloudSecurityControllerGetCheckDefinitionV1Request$zodSchema,
} from "../models/cloudsecuritycontrollergetcheckdefinitionv1op.js";
...
export function cloudSecurityCloudSecurityControllerGetCheckDefinitionV1(
  client$: CompAiCore,
  request: CloudSecurityControllerGetCheckDefinitionV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      CloudSecurityControllerGetCheckDefinitionV1Request$zodSchema.parse(
        value$,
      ),
