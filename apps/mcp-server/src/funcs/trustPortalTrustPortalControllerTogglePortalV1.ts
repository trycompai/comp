...
import { TrustPortalControllerTogglePortalV1Security } from "../models/trustportalcontrollertoggleportalv1op.js";
 ...
 */
export function trustPortalTrustPortalControllerTogglePortalV1(
  client$: CompAiCore,
  security: TrustPortalControllerTogglePortalV1Security,
...
> {
  const path$ = pathToFunc("/v1/trust-portal/settings/toggle")();
