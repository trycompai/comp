...
import {
  ...
  SetTwoFactorSourceDto$zodSchema,
} from "../models/settwofactorsourcedto.js";
 ...
 */
export function integrationsTwoFactorSourceControllerSetTwoFactorSourceV1(
  client$: CompAiCore,
  request: SetTwoFactorSourceDto,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => SetTwoFactorSourceDto$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/v1/integrations/sync/two-factor-source")();
