...
import { FrameworksControllerGetAllUpdateStatusesV1Security } from "../models/frameworkscontrollergetallupdatestatusesv1op.js";
...
export function frameworksFrameworksControllerGetAllUpdateStatusesV1(
  client$: CompAiCore,
  security: FrameworksControllerGetAllUpdateStatusesV1Security,
...
> {
  const path$ = pathToFunc("/v1/frameworks/update-statuses")();
  ...
  const context = {
    ...
    operationID: "FrameworksController_getAllUpdateStatuses_v1",
    oAuth2Scopes: null,
