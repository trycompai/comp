...
import { TrustPortalControllerUpdateFrameworksV1Security } from "../models/trustportalcontrollerupdateframeworksv1op.js";
 ...
 */
export function trustPortalTrustPortalControllerUpdateFrameworksV1(
  client$: CompAiCore,
  security: TrustPortalControllerUpdateFrameworksV1Security,
...
> {
  const path$ = pathToFunc("/v1/trust-portal/settings/frameworks")();
