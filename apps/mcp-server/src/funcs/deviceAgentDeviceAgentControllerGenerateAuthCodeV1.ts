...
import { AuthCodeDto } from "../models/authcodedto.js";
...
> {
  const path$ = pathToFunc("/v1/device-agent/auth-code")();
  ...
  const context = {
    ...
    operationID: "DeviceAgentController_generateAuthCode_v1",
    oAuth2Scopes: null,
