...
import { ExportQuestionnaireDto } from "../models/exportquestionnairedto.js";
import { QuestionnaireControllerAutoAnswerAndExportV1Security } from "../models/questionnairecontrollerautoanswerandexportv1op.js";
...
export function questionnaireQuestionnaireControllerAutoAnswerAndExportV1(
  client$: CompAiCore,
  security: QuestionnaireControllerAutoAnswerAndExportV1Security,
...
> {
  const path$ = pathToFunc("/v1/questionnaire/answers/export")();
