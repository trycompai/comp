...
import {
  ...
  PoliciesControllerGetPolicyV1Request$zodSchema,
  PoliciesControllerGetPolicyV1Security,
} from "../models/policiescontrollergetpolicyv1op.js";
...
export function policiesPoliciesControllerGetPolicyV1(
  client$: CompAiCore,
  security: PoliciesControllerGetPolicyV1Security,
  request: PoliciesControllerGetPolicyV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => PoliciesControllerGetPolicyV1Request$zodSchema.parse(value$),
