...
import {
  ...
  VariablesControllerGetConnectionVariablesV1Request$zodSchema,
  VariablesControllerGetConnectionVariablesV1Security,
} from "../models/variablescontrollergetconnectionvariablesv1op.js";
 ...
 */
export function integrationsVariablesControllerGetConnectionVariablesV1(
  client$: CompAiCore,
  security: VariablesControllerGetConnectionVariablesV1Security,
  request: VariablesControllerGetConnectionVariablesV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      VariablesControllerGetConnectionVariablesV1Request$zodSchema.parse(
        value$,
      ),
