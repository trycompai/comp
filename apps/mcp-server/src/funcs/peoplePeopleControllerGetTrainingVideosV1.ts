...
import {
  ...
  PeopleControllerGetTrainingVideosV1Request$zodSchema,
  PeopleControllerGetTrainingVideosV1Security,
} from "../models/peoplecontrollergettrainingvideosv1op.js";
 ...
 */
export function peoplePeopleControllerGetTrainingVideosV1(
  client$: CompAiCore,
  security: PeopleControllerGetTrainingVideosV1Security,
  request: PeopleControllerGetTrainingVideosV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      PeopleControllerGetTrainingVideosV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/v1/people/{id}/training-videos")(
    pathParams$,
  );
