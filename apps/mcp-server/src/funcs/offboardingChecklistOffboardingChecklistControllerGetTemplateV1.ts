...
import { OffboardingChecklistControllerGetTemplateV1Security } from "../models/offboardingchecklistcontrollergettemplatev1op.js";
...
export function offboardingChecklistOffboardingChecklistControllerGetTemplateV1(
  client$: CompAiCore,
  security: OffboardingChecklistControllerGetTemplateV1Security,
...
> {
  ...
  const context = {
    ...
    operationID: "OffboardingChecklistController_getTemplate_v1",
    oAuth2Scopes: null,
