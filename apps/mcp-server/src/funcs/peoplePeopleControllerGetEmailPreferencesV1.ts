...
import { PeopleControllerGetEmailPreferencesV1Security } from "../models/peoplecontrollergetemailpreferencesv1op.js";
...
export function peoplePeopleControllerGetEmailPreferencesV1(
  client$: CompAiCore,
  security: PeopleControllerGetEmailPreferencesV1Security,
