...
import {
  ...
  TasksControllerGetTasksV1Request$zodSchema,
  TasksControllerGetTasksV1Security,
} from "../models/taskscontrollergettasksv1op.js";
...
export function tasksTasksControllerGetTasksV1(
  client$: CompAiCore,
  security: TasksControllerGetTasksV1Security,
  request?: TasksControllerGetTasksV1Request | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      TasksControllerGetTasksV1Request$zodSchema.optional().parse(value$),
