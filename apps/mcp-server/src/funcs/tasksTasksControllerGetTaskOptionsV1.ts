...
import { TasksControllerGetTaskOptionsV1Security } from "../models/taskscontrollergettaskoptionsv1op.js";
 ...
 */
export function tasksTasksControllerGetTaskOptionsV1(
  client$: CompAiCore,
  security: TasksControllerGetTaskOptionsV1Security,
...
> {
  const path$ = pathToFunc("/v1/tasks/options")();
