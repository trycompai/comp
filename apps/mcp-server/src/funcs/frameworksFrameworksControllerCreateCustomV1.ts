...
import {
  ...
  CreateCustomFrameworkDto$zodSchema,
} from "../models/createcustomframeworkdto.js";
...
import { FrameworksControllerCreateCustomV1Security } from "../models/frameworkscontrollercreatecustomv1op.js";
...
export function frameworksFrameworksControllerCreateCustomV1(
  client$: CompAiCore,
  security: FrameworksControllerCreateCustomV1Security,
  request: CreateCustomFrameworkDto,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateCustomFrameworkDto$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/v1/frameworks/custom")();
