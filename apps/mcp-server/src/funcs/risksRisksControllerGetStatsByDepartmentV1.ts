...
import { RisksControllerGetStatsByDepartmentV1Security } from "../models/riskscontrollergetstatsbydepartmentv1op.js";
 ...
 */
export function risksRisksControllerGetStatsByDepartmentV1(
  client$: CompAiCore,
  security: RisksControllerGetStatsByDepartmentV1Security,
...
> {
  const path$ = pathToFunc("/v1/risks/stats/by-department")();
