...
import {
  CloudSecurityControllerSelectGcpProjectsV1Request,
  CloudSecurityControllerSelectGcpProjectsV1Request$zodSchema,
} from "../models/cloudsecuritycontrollerselectgcpprojectsv1op.js";
 ...
 */
export function cloudSecurityCloudSecurityControllerSelectGcpProjectsV1(
  client$: CompAiCore,
  request: CloudSecurityControllerSelectGcpProjectsV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      CloudSecurityControllerSelectGcpProjectsV1Request$zodSchema.parse(value$),
