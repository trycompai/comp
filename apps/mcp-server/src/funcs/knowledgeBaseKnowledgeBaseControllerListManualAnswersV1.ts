...
import { KnowledgeBaseControllerListManualAnswersV1Security } from "../models/knowledgebasecontrollerlistmanualanswersv1op.js";
...
export function knowledgeBaseKnowledgeBaseControllerListManualAnswersV1(
  client$: CompAiCore,
  security: KnowledgeBaseControllerListManualAnswersV1Security,
