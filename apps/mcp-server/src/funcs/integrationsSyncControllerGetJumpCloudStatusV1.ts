...
import { SyncControllerGetJumpCloudStatusV1Security } from "../models/synccontrollergetjumpcloudstatusv1op.js";
...
export function integrationsSyncControllerGetJumpCloudStatusV1(
  client$: CompAiCore,
  security: SyncControllerGetJumpCloudStatusV1Security,
