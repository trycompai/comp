...
import { TrustPortalControllerUpdateOverviewV1Security } from "../models/trustportalcontrollerupdateoverviewv1op.js";
...
export function trustPortalTrustPortalControllerUpdateOverviewV1(
  client$: CompAiCore,
  security: TrustPortalControllerUpdateOverviewV1Security,
