...
import {
  ...
  FrameworksControllerLinkControlsV1Request$zodSchema,
  FrameworksControllerLinkControlsV1Security,
} from "../models/frameworkscontrollerlinkcontrolsv1op.js";
...
export function frameworksFrameworksControllerLinkControlsV1(
  client$: CompAiCore,
  security: FrameworksControllerLinkControlsV1Security,
  request: FrameworksControllerLinkControlsV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      FrameworksControllerLinkControlsV1Request$zodSchema.parse(value$),
