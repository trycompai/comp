...
import {
  ...
  PeopleControllerGetAllPeopleV1Request$zodSchema,
  PeopleControllerGetAllPeopleV1Security,
} from "../models/peoplecontrollergetallpeoplev1op.js";
...
export function peoplePeopleControllerGetAllPeopleV1(
  client$: CompAiCore,
  security: PeopleControllerGetAllPeopleV1Security,
  request: PeopleControllerGetAllPeopleV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => PeopleControllerGetAllPeopleV1Request$zodSchema.parse(value$),
