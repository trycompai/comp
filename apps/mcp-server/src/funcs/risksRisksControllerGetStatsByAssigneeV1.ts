...
import { RisksControllerGetStatsByAssigneeV1Security } from "../models/riskscontrollergetstatsbyassigneev1op.js";
 ...
 */
export function risksRisksControllerGetStatsByAssigneeV1(
  client$: CompAiCore,
  security: RisksControllerGetStatsByAssigneeV1Security,
...
> {
  const path$ = pathToFunc("/v1/risks/stats/by-assignee")();
