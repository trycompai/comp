 ...
 */
export function taskAutomationsAutomationsControllerUpdateAutomationV1(
  client$: CompAiCore,
  security: AutomationsControllerUpdateAutomationV1Security,
  request: AutomationsControllerUpdateAutomationV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      AutomationsControllerUpdateAutomationV1Request$zodSchema.parse(value$),
