...
import {
  PoliciesControllerConfirmPolicyPdfUploadedV1Request,
  PoliciesControllerConfirmPolicyPdfUploadedV1Request$zodSchema,
  PoliciesControllerConfirmPolicyPdfUploadedV1Security,
} from "../models/policiescontrollerconfirmpolicypdfuploadedv1op.js";
...
export function policiesPoliciesControllerConfirmPolicyPdfUploadedV1(
  client$: CompAiCore,
  security: PoliciesControllerConfirmPolicyPdfUploadedV1Security,
  request: PoliciesControllerConfirmPolicyPdfUploadedV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      PoliciesControllerConfirmPolicyPdfUploadedV1Request$zodSchema.parse(
        value$,
      ),
  ...
  const path$ = pathToFunc("/v1/policies/{id}/pdf/confirm")(
    pathParams$,
  );
