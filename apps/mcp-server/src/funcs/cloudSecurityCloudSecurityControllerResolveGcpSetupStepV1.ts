...
import {
  CloudSecurityControllerResolveGcpSetupStepV1Request,
  CloudSecurityControllerResolveGcpSetupStepV1Request$zodSchema,
} from "../models/cloudsecuritycontrollerresolvegcpsetupstepv1op.js";
 ...
 */
export function cloudSecurityCloudSecurityControllerResolveGcpSetupStepV1(
  client$: CompAiCore,
  request: CloudSecurityControllerResolveGcpSetupStepV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      CloudSecurityControllerResolveGcpSetupStepV1Request$zodSchema.parse(
        value$,
      ),
