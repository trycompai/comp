...
import {
  PoliciesControllerSubmitVersionForApprovalV1Request,
  PoliciesControllerSubmitVersionForApprovalV1Request$zodSchema,
  PoliciesControllerSubmitVersionForApprovalV1Security,
} from "../models/policiescontrollersubmitversionforapprovalv1op.js";
...
export function policiesPoliciesControllerSubmitVersionForApprovalV1(
  client$: CompAiCore,
  security: PoliciesControllerSubmitVersionForApprovalV1Security,
  request: PoliciesControllerSubmitVersionForApprovalV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      PoliciesControllerSubmitVersionForApprovalV1Request$zodSchema.parse(
        value$,
      ),
