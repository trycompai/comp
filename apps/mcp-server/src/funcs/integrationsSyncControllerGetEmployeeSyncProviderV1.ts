...
import { SyncControllerGetEmployeeSyncProviderV1Security } from "../models/synccontrollergetemployeesyncproviderv1op.js";
 ...
 */
export function integrationsSyncControllerGetEmployeeSyncProviderV1(
  client$: CompAiCore,
  security: SyncControllerGetEmployeeSyncProviderV1Security,
