...
import { ExportByIdDto } from "../models/exportbyiddto.js";
import { QuestionnaireControllerExportByIdV1Security } from "../models/questionnairecontrollerexportbyidv1op.js";
...
export function questionnaireQuestionnaireControllerExportByIdV1(
  client$: CompAiCore,
  security: QuestionnaireControllerExportByIdV1Security,
...
> {
  const path$ = pathToFunc("/v1/questionnaire/export")();
