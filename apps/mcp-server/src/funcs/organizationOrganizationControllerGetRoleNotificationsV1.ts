...
import { OrganizationControllerGetRoleNotificationsV1Security } from "../models/organizationcontrollergetrolenotificationsv1op.js";
...
export function organizationOrganizationControllerGetRoleNotificationsV1(
  client$: CompAiCore,
  security: OrganizationControllerGetRoleNotificationsV1Security,
