...
import {
  ...
  CloudSecurityControllerSetupGcpV1Request$zodSchema,
} from "../models/cloudsecuritycontrollersetupgcpv1op.js";
...
export function cloudSecurityCloudSecurityControllerSetupGcpV1(
  client$: CompAiCore,
  request: CloudSecurityControllerSetupGcpV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      CloudSecurityControllerSetupGcpV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/v1/cloud-security/setup-gcp/{connectionId}")(
    pathParams$,
  );
