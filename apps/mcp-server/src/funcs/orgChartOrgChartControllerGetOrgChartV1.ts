...
import {
  ...
  OrgChartControllerGetOrgChartV1Request$zodSchema,
  OrgChartControllerGetOrgChartV1Security,
} from "../models/orgchartcontrollergetorgchartv1op.js";
...
export function orgChartOrgChartControllerGetOrgChartV1(
  client$: CompAiCore,
  security: OrgChartControllerGetOrgChartV1Security,
  request?: OrgChartControllerGetOrgChartV1Request | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      OrgChartControllerGetOrgChartV1Request$zodSchema.optional().parse(value$),
