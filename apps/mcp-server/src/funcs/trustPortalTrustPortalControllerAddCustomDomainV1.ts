...
import { TrustPortalControllerAddCustomDomainV1Security } from "../models/trustportalcontrolleraddcustomdomainv1op.js";
 ...
 */
export function trustPortalTrustPortalControllerAddCustomDomainV1(
  client$: CompAiCore,
  security: TrustPortalControllerAddCustomDomainV1Security,
...
> {
  const path$ = pathToFunc("/v1/trust-portal/settings/custom-domain")();
