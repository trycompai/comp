...
import {
  ...
  FrameworksControllerDeleteV1Request$zodSchema,
  FrameworksControllerDeleteV1Security,
} from "../models/frameworkscontrollerdeletev1op.js";
...
export function frameworksFrameworksControllerDeleteV1(
  client$: CompAiCore,
  security: FrameworksControllerDeleteV1Security,
  request: FrameworksControllerDeleteV1Request,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => FrameworksControllerDeleteV1Request$zodSchema.parse(value$),
