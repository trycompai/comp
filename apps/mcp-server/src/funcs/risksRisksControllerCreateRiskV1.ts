...
import {
  CreateRiskDto,
  CreateRiskDto$zodSchema,
} from "../models/createriskdto.js";
...
import { RisksControllerCreateRiskV1Security } from "../models/riskscontrollercreateriskv1op.js";
...
export function risksRisksControllerCreateRiskV1(
  client$: CompAiCore,
  security: RisksControllerCreateRiskV1Security,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateRiskDto$zodSchema.parse(value$),
