...
import {
  ...
  EvidenceFormsControllerGetSubmissionV1Request$zodSchema,
  EvidenceFormsControllerGetSubmissionV1Security,
} from "../models/evidenceformscontrollergetsubmissionv1op.js";
 ...
 */
export function evidenceFormsEvidenceFormsControllerGetSubmissionV1(
  client$: CompAiCore,
  security: EvidenceFormsControllerGetSubmissionV1Security,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      EvidenceFormsControllerGetSubmissionV1Request$zodSchema.parse(value$),
