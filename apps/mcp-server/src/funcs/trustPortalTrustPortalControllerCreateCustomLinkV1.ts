...
import { TrustPortalControllerCreateCustomLinkV1Security } from "../models/trustportalcontrollercreatecustomlinkv1op.js";
...
export function trustPortalTrustPortalControllerCreateCustomLinkV1(
  client$: CompAiCore,
  security: TrustPortalControllerCreateCustomLinkV1Security,
