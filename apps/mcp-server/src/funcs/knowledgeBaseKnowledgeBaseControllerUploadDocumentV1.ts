...
import { KnowledgeBaseControllerUploadDocumentV1Security } from "../models/knowledgebasecontrolleruploaddocumentv1op.js";
...
export function knowledgeBaseKnowledgeBaseControllerUploadDocumentV1(
  client$: CompAiCore,
  security: KnowledgeBaseControllerUploadDocumentV1Security,
