...
export type PeopleControllerUpdateEmailPreferencesV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const PeopleControllerUpdateEmailPreferencesV1Security$zodSchema:
  z.ZodType<PeopleControllerUpdateEmailPreferencesV1Security> = z.object({
