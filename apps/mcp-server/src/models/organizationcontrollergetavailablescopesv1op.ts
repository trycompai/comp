...
export type OrganizationControllerGetAvailableScopesV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const OrganizationControllerGetAvailableScopesV1Security$zodSchema:
  z.ZodType<OrganizationControllerGetAvailableScopesV1Security> = z.object({
