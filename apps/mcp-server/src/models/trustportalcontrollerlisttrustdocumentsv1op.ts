...
export type TrustPortalControllerListTrustDocumentsV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TrustPortalControllerListTrustDocumentsV1Security$zodSchema:
  z.ZodType<TrustPortalControllerListTrustDocumentsV1Security> = z.object({
