...
export type TrainingControllerGenerateHipaaCertificateV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TrainingControllerGenerateHipaaCertificateV1Security$zodSchema:
  z.ZodType<TrainingControllerGenerateHipaaCertificateV1Security> = z.object({
