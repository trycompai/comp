...
export type TrustPortalControllerReorderCustomLinksV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TrustPortalControllerReorderCustomLinksV1Security$zodSchema:
  z.ZodType<TrustPortalControllerReorderCustomLinksV1Security> = z.object({
