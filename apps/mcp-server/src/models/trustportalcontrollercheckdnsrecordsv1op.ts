...
export type TrustPortalControllerCheckDnsRecordsV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TrustPortalControllerCheckDnsRecordsV1Security$zodSchema:
  z.ZodType<TrustPortalControllerCheckDnsRecordsV1Security> = z.object({
