...
export type KnowledgeBaseControllerProcessDocumentsV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const KnowledgeBaseControllerProcessDocumentsV1Security$zodSchema:
  z.ZodType<KnowledgeBaseControllerProcessDocumentsV1Security> = z.object({
