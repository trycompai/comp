...
export type TrustPortalControllerUpdateAllowedDomainsV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TrustPortalControllerUpdateAllowedDomainsV1Security$zodSchema:
  z.ZodType<TrustPortalControllerUpdateAllowedDomainsV1Security> = z.object({
