...
export type OffboardingChecklistControllerGetTemplateV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const OffboardingChecklistControllerGetTemplateV1Security$zodSchema:
  z.ZodType<OffboardingChecklistControllerGetTemplateV1Security> = z.object({
