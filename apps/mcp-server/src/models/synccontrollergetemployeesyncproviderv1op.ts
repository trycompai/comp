...
export type SyncControllerGetEmployeeSyncProviderV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const SyncControllerGetEmployeeSyncProviderV1Security$zodSchema:
  z.ZodType<SyncControllerGetEmployeeSyncProviderV1Security> = z.object({
