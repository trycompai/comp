...
export type KnowledgeBaseControllerListManualAnswersV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const KnowledgeBaseControllerListManualAnswersV1Security$zodSchema:
  z.ZodType<KnowledgeBaseControllerListManualAnswersV1Security> = z.object({
