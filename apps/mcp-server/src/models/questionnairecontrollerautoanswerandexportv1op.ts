...
export type QuestionnaireControllerAutoAnswerAndExportV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const QuestionnaireControllerAutoAnswerAndExportV1Security$zodSchema:
  z.ZodType<QuestionnaireControllerAutoAnswerAndExportV1Security> = z.object({
