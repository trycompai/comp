...
export type SOAControllerExportDocumentV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const SOAControllerExportDocumentV1Security$zodSchema: z.ZodType<
  SOAControllerExportDocumentV1Security
> = z.object({
