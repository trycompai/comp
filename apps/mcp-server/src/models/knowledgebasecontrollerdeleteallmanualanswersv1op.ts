...
export type KnowledgeBaseControllerDeleteAllManualAnswersV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const KnowledgeBaseControllerDeleteAllManualAnswersV1Security$zodSchema:
  z.ZodType<KnowledgeBaseControllerDeleteAllManualAnswersV1Security> = z.object(
    {
