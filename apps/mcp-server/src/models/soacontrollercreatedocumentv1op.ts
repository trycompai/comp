...
export type SOAControllerCreateDocumentV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const SOAControllerCreateDocumentV1Security$zodSchema: z.ZodType<
  SOAControllerCreateDocumentV1Security
> = z.object({
