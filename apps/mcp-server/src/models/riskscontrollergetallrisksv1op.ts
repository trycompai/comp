...
export type RisksControllerGetAllRisksV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const RisksControllerGetAllRisksV1Security$zodSchema: z.ZodType<
  RisksControllerGetAllRisksV1Security
> = z.object({
