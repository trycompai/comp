...
export type OffboardingChecklistControllerCreateTemplateItemV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const OffboardingChecklistControllerCreateTemplateItemV1Security$zodSchema:
  z.ZodType<OffboardingChecklistControllerCreateTemplateItemV1Security> = z
    .object({
