...
export type OrganizationControllerRevokeApiKeyV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const OrganizationControllerRevokeApiKeyV1Security$zodSchema: z.ZodType<
  OrganizationControllerRevokeApiKeyV1Security
> = z.object({
