...
export type TrustPortalControllerGetComplianceResourceUrlV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TrustPortalControllerGetComplianceResourceUrlV1Security$zodSchema:
  z.ZodType<TrustPortalControllerGetComplianceResourceUrlV1Security> = z.object(
    {
