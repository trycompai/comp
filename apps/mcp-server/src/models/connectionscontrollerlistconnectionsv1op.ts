...
export type ConnectionsControllerListConnectionsV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const ConnectionsControllerListConnectionsV1Security$zodSchema:
  z.ZodType<ConnectionsControllerListConnectionsV1Security> = z.object({
