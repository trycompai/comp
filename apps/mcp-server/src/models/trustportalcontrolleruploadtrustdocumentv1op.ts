...
export type TrustPortalControllerUploadTrustDocumentV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TrustPortalControllerUploadTrustDocumentV1Security$zodSchema:
  z.ZodType<TrustPortalControllerUploadTrustDocumentV1Security> = z.object({
