...
export type OffboardingChecklistControllerExportAllEvidenceV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const OffboardingChecklistControllerExportAllEvidenceV1Security$zodSchema:
  z.ZodType<OffboardingChecklistControllerExportAllEvidenceV1Security> = z
    .object({
