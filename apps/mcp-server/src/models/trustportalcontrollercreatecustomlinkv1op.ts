...
export type TrustPortalControllerCreateCustomLinkV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TrustPortalControllerCreateCustomLinkV1Security$zodSchema:
  z.ZodType<TrustPortalControllerCreateCustomLinkV1Security> = z.object({
