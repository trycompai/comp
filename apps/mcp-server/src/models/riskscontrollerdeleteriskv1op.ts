...
export type RisksControllerDeleteRiskV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const RisksControllerDeleteRiskV1Security$zodSchema: z.ZodType<
  RisksControllerDeleteRiskV1Security
> = z.object({
