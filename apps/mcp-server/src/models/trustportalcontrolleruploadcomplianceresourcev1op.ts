...
export type TrustPortalControllerUploadComplianceResourceV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TrustPortalControllerUploadComplianceResourceV1Security$zodSchema:
  z.ZodType<TrustPortalControllerUploadComplianceResourceV1Security> = z.object(
    {
