...
export type PeopleControllerGetTestStatsByAssigneeV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const PeopleControllerGetTestStatsByAssigneeV1Security$zodSchema:
  z.ZodType<PeopleControllerGetTestStatsByAssigneeV1Security> = z.object({
