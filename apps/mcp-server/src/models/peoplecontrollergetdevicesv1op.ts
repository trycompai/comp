...
export type PeopleControllerGetDevicesV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const PeopleControllerGetDevicesV1Security$zodSchema: z.ZodType<
  PeopleControllerGetDevicesV1Security
> = z.object({
