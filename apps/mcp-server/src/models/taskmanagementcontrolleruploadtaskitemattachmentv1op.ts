...
export type TaskManagementControllerUploadTaskItemAttachmentV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TaskManagementControllerUploadTaskItemAttachmentV1Security$zodSchema:
  z.ZodType<TaskManagementControllerUploadTaskItemAttachmentV1Security> = z
    .object({
