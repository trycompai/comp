...
export type PoliciesControllerRequestPolicyPdfUploadUrlV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const PoliciesControllerRequestPolicyPdfUploadUrlV1Security$zodSchema:
  z.ZodType<PoliciesControllerRequestPolicyPdfUploadUrlV1Security> = z.object({
...
export type PoliciesControllerRequestPolicyPdfUploadUrlV1Request = {
  xOrganizationId?: string | undefined;
  id: string;
  body: RequestPolicyPdfUploadUrlDto;
};

export const PoliciesControllerRequestPolicyPdfUploadUrlV1Request$zodSchema:
  z.ZodType<PoliciesControllerRequestPolicyPdfUploadUrlV1Request> = z.object({
    body: RequestPolicyPdfUploadUrlDto$zodSchema,
