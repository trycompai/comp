...
export type TrustPortalControllerUpdateFrameworksV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TrustPortalControllerUpdateFrameworksV1Security$zodSchema:
  z.ZodType<TrustPortalControllerUpdateFrameworksV1Security> = z.object({
