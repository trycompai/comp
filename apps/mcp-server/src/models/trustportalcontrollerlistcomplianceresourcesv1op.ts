...
export type TrustPortalControllerListComplianceResourcesV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const TrustPortalControllerListComplianceResourcesV1Security$zodSchema:
  z.ZodType<TrustPortalControllerListComplianceResourcesV1Security> = z.object({
