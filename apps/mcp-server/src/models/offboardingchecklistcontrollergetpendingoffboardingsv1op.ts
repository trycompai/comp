...
export type OffboardingChecklistControllerGetPendingOffboardingsV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const OffboardingChecklistControllerGetPendingOffboardingsV1Security$zodSchema:
  z.ZodType<OffboardingChecklistControllerGetPendingOffboardingsV1Security> = z
    .object({
