...
export type KnowledgeBaseControllerUploadDocumentV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const KnowledgeBaseControllerUploadDocumentV1Security$zodSchema:
  z.ZodType<KnowledgeBaseControllerUploadDocumentV1Security> = z.object({
