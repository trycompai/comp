...
export type KnowledgeBaseControllerSaveManualAnswerV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const KnowledgeBaseControllerSaveManualAnswerV1Security$zodSchema:
  z.ZodType<KnowledgeBaseControllerSaveManualAnswerV1Security> = z.object({
