...
export type OrganizationControllerGetRoleNotificationsV1Security = {
  apikey?: string | undefined;
  oauth2?: string | undefined;
};

export const OrganizationControllerGetRoleNotificationsV1Security$zodSchema:
  z.ZodType<OrganizationControllerGetRoleNotificationsV1Security> = z.object({
