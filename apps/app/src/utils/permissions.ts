...
/**
 * Program Manager role - Full GRC access, no platform admin
 * Can manage all compliance resources but not organization settings or members
 */
export const program_manager = ac.newRole({
  organization: ['read'],
  // No member/invitation management (unlike admin)
  // Full GRC access
  control: ['create', 'read', 'update', 'delete', 'assign', 'export'],
  evidence: ['create', 'read', 'update', 'delete', 'upload', 'export'],
  policy: ['create', 'read', 'update', 'delete', 'publish', 'approve'],
  ...
  finding: ['create', 'read', 'update', 'delete'],
  questionnaire: ['create', 'read', 'update', 'delete', 'respond'],
  integration: ['read'], // Can view integrations but not manage
  // Legacy
  app: ['read'],
  portal: ['read', 'update'],
});
