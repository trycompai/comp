export default {
  ...
  tests: {
    ...
    assignedUser: {
      ...
      placeholder: "Sélectionnez un utilisateur à assigner",
      update_success: "Affectation de l'utilisateur mise à jour avec succès",
      update_error: "Échec de la mise à jour de l'affectation de l'utilisateur"
    },
    table: {
      title: "Titre",
