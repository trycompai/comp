export const people = {
	...
	member_actions: {
		...
		remove_confirm: {
			...
			description_prefix: "¿Estás seguro de que quieres eliminar a",
	...
	invite: {
		...
		csv: {
			label: "Archivo CSV",
			description:
				"Sube un archivo CSV con columnas de correo electrónico y rol. El rol puede ser uno de: admin, employee o auditor.",
