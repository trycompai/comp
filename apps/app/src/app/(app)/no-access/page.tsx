      ...
      <div className="bg-foreground/05 flex flex-1 flex-col items-center justify-center gap-4">
        ...
        <div className="flex flex-col text-center">
          <p>
            ...
            <Link href={process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.trycomp.ai"} className="text-primary underline">
              {process.env.NEXT_PUBLIC_PORTAL_URL?.replace(/^https?:\/\//, "") ?? "portal.trycomp.ai"}
            </Link>
            .
          </p>
