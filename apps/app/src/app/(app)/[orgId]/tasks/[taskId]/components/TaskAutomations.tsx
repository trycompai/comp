...
export const TaskAutomations = ({ automations }: TaskAutomationsProps) => {
  ...
  // If there are no automations, show a minimal inline prompt
  if (automations.length === 0) {
    return (
      <button
        onClick={handleCreateAutomation}
        className="w-full flex items-center gap-3 px-4 py-3 rounded-lg border border-dashed border-border/60 hover:border-border hover:bg-muted/30 transition-all group text-left"
      >
        <div className="w-8 h-8 rounded-md bg-muted/50 flex items-center justify-center group-hover:bg-muted transition-colors shrink-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] text-muted-foreground/60">
            Build an AI automation for this task
          </p>
        </div>
