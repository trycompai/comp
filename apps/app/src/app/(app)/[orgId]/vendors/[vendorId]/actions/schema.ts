...
export const getCreateVendorTaskCommentSchema = (t: (content: string) => string) => z.object({
...
export const getCreateVendorTaskSchema = (t: (content: string) => string) => z.object({
  vendorId: z.string().min(1, {
    message: t('Vendor ID is required'),
  }),
...
export const getVendorContactSchema = (t: (content: string) => string) => z.object({
  name: z.string().min(1, t('Name is required')),
  email: z.string().email(t('Invalid email address')),
  role: z.string().min(1, t('Role is required')),
});

export const getCreateVendorSchema = (t: (content: string) => string) => z.object({
  name: z.string().min(1, t('Name is required')),
...
export const getUpdateVendorSchema = (t: (content: string) => string) => z.object({
  id: z.string(),
  name: z.string().min(1, t('Name is required')),
  description: z.string().min(1, t('Description is required')),
  category: z.nativeEnum(VendorCategory),
...
export const getCreateVendorCommentSchema = (t: (content: string) => string) => z.object({
  vendorId: z.string(),
  content: z.string().min(1),
});

export const getUpdateVendorRiskSchema = (t: (content: string) => string) => z.object({
  id: z.string(),
  inherent_risk: z.enum(['low', 'medium', 'high', 'unknown']).optional(),
  residual_risk: z.enum(['low', 'medium', 'high', 'unknown']).optional(),
});

export const getUpdateVendorTaskSchema = (t: (content: string) => string) => z.object({
  id: z.string().min(1, {
    message: t('Task ID is required'),
  }),
  vendorId: z.string().min(1, {
