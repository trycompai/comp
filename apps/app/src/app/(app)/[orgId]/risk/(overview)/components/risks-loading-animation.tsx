...
export function RisksLoadingAnimation() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] py-16 px-4">
      ...
      >
        <h3 className="text-lg font-semibold">AI is working on your risks</h3>
        <p className="text-muted-foreground text-sm max-w-md">
          Our AI is analyzing your organization and creating personalized risks. This may take a few
          moments.
        </p>
      </motion.div>
    </div>
