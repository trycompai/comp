...
const KNOWN_STATUS_SET: ReadonlySet<RunStatus> = new Set<RunStatus>(
  RUN_STATUS_VALUES_INTERNAL,
);
...
const SUCCESS_STATUS_SET: ReadonlySet<RunStatus> = new Set<RunStatus>([
  "COMPLETED",
]);
