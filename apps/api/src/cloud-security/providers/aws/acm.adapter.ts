        ...
        for (const summary of listRes.CertificateSummaryList ?? []) {
          ...
          if (notAfter) {
            ...
            if (daysUntilExpiry < 0) {
              ...
              findings.push(
                this.makeFinding(arn, 'Certificate is valid', `Certificate expires in ${daysUntilExpiry} days`, 'info', { daysUntilExpiry, notAfter: notAfter.toISOString() }, true),
              );
            }
          }
