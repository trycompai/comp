...
export const PromptInputSubmit = ({
  ...
  if (status === "error") {
    ...
    content = (
      <span className="text-primary-foreground/90 flex items-center gap-1 text-xs leading-none font-medium">
        {isMac ? "⌘" : "Ctrl"}
  ...
  return (
    <InputGroupButton
      aria-label="Submit"
      className={cn("flex !h-8 items-center justify-center !px-2", className)}
      size="xs"
      type="submit"
      variant={variant}
      {...props}
