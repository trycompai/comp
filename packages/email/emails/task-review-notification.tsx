...
export const TaskReviewNotificationEmail = ({
  email,
  userName,
  taskName,
  organizationName,
  ...
  const link = `${process.env.NEXT_PUBLIC_APP_URL ?? 'https://app.trycomp.ai'}/${organizationId}/tasks/${taskId}`;
  const subjectText = 'Task review required';
        ...
        <Body className="mx-auto my-auto bg-[#fff] font-sans">
          ...
          >
            ...
            <Text className="text-[14px] leading-[24px] text-[#121212]">
              The "{taskName}" task for <strong>{organizationName}</strong> is due for review. Please review and update it.
            </Text>
...
export default TaskReviewNotificationEmail;
