export type Token =
  ...
  | 'colors.rose.solid'
  | 'colors.rose.emphasized'
  | 'colors.rose.hover'
  | 'colors.rose.active'
  | 'colors.rose.subtle'
  | 'colors.rose.muted'
  | 'colors.rose.fg'
  | 'colors.rose.contrast'
  | 'colors.rose.border'
  | 'colors.rose.focusRing'
  | 'colors.sand.solid'
  ...
  | 'colors.sand.muted'
  | 'colors.sand.fg'
  | 'colors.sand.contrast'
  | 'colors.sand.border'
  | 'colors.sand.focusRing'
  | 'shadows.xs'
  | 'shadows.sm'
  | 'shadows.md'
  | 'shadows.lg'
...
export type BordersToken = 'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'none' | 'subtle' | 'strong';
...
export type LetterSpacingsToken = 'tighter' | 'tight' | 'wide' | 'wider' | 'widest' | 'brand';

export type LineHeightsToken = 'shorter' | 'short' | 'moderate' | 'tall' | 'taller' | 'brand';
