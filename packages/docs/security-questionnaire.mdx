...
description: 'Automatically answer vendor security questionnaires with approved policies, knowledge base documents, and Comp AI review workflows.'
---

<Note>
  For external users accessing via Trust Access tokens, see [Security
  Questionnaire](./security-questionnaire-trust-center) in the Trust section.
</Note>
