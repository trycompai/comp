...
If your device previously had the old Fleet-based agent installed, you should uninstall it after setting up the new Comp AI Device Agent. The new agent fully replaces the old one, and having both running is unnecessary.

Follow the official FleetDM uninstall guide for your platform: [How to uninstall fleetd](https://fleetdm.com/guides/how-to-uninstall-fleetd)

After uninstalling, ask your IT administrator to remove the old device from your profile using the "Remove Device" action in the admin dashboard.
