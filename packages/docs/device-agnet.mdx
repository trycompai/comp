...
Step 1: Run "run_me_first.command"
...
<Accordion title="Step 3" description="Enable MDM" icon="computer">
  ...
  In System Settings, locate and click ‘Profile Downloaded’ in the left-hand column:

  Double-click on the Comp AI enrollment on the right:
