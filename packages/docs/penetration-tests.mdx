...
description: 'Create AI-assisted penetration test runs, track security findings, and download Markdown or PDF report deliverables.'
---
...
<Accordion
  title="I do not see the Penetration Tests tab"
  description="Feature access and visibility"
  icon="warning"
>
...
<Accordion
  title="My run is stuck in queue or progress is delayed"
  description="Status updates and provider execution"
  icon="clock"
>
