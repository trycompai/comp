...
Use it to automate evidence collection, manage policies, coordinate compliance tasks, answer security questionnaires, configure Trust Center access, track risks and vendors, and keep SOC 2, ISO 27001, HIPAA, GDPR, and FedRAMP programs connected to the systems where work actually happens.
...
Some reference pages document other authentication flows because they are part of the product surface:

- Trust Access endpoints can use tokenized reviewer links for customer security reviews.
...
- Internal, admin-only, health, assistant, and browser automation routes are excluded from Mintlify docs.
