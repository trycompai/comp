...
-- CreateEnum
CREATE TYPE "PhaseCompletionType" AS ENUM ('AUTO_TASKS', 'AUTO_UPLOAD', 'MANUAL');
...
-- CreateIndex
CREATE UNIQUE INDEX "TimelineTemplate_frameworkId_cycleNumber_key" ON "TimelineTemplate"("frameworkId", "cycleNumber");

-- CreateIndex
CREATE UNIQUE INDEX "TimelineInstance_frameworkInstanceId_cycleNumber_key" ON "TimelineInstance"("frameworkInstanceId", "cycleNumber");
